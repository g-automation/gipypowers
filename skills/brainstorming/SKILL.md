...
- For appropriately-scoped projects: one question per message, multiple choice preferred (open-ended is fine too); if a topic needs more exploration, break it into multiple questions. Focus on understanding purpose, constraints, success criteria.
